...
//Adds the authentication system to our middleware.
//This muct be above the Authorization middleware.
app.UseAuthentication();
app.UseAuthorization();

//Tells the application to use our session data and session cookies.
app.UseSession();
